...
st.swrite("Although 32 thousand is a lot of people, it is by no mean everyone. When selecting individuals for these dataset, it was noticed that different gorups were under or over represented, and so an attribute called 'final weight' was generated to compensate for this (More information in dataset information).")
