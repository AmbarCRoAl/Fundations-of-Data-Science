...
if sd == "Age and gender":
        ...
        col2.write("The graph on the left shows the percentage of people who earned over \$50,000 per year (over-earners) by marital status. It is evident that the percentage of married people who are over-earners is significantly higher than for any other, representing almost half of that population, and followed by divorced with slightly higher than 10%.")
